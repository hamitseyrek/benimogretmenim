...
class _BodyState extends State<Body> {
  ...
  List<Map<String, String>> splashData = [
    {
      "text": "Çözüldü uyguaması ile soru çödürmek çok kolay!",
      "image": "assets/images/splash_1.png"
    },
    {
      "text": "Sorunun ressmini çek gönder.",
      "image": "assets/images/splash_2.png"
    },
    {
      "text":
          "Uzman kadromuz tarafından çözülen \nsorunun çözüm videosu anında gelsin sana",
